...
COPY ./Code/Services/AccommodationService/src ./Services/AccommodationService/src
COPY ./Code/Services/AccommodationService/CMakeLists.txt ./Services/AccommodationService
RUN mkdir ./Services/AccommodationService/build
RUN cmake -B ./Services/AccommodationService/build -S ./Services/AccommodationService
RUN make -C ./Services/AccommodationService/build
ENTRYPOINT [ "./Services/AccommodationService/build/accommodation_service" ]
